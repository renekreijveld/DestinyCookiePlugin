...
class plgSystemDestinycookiepluginInstallerScript
{
	...
	public function postflight($type, $parent)
	{
		...
		{
			$message = "<h3><b>Destiny Cookie Plugin 1.0.10</b></h3>
			...
			Versie 1.0.10, copyright &copy; 2021 - $year Destiny B.V., alle rechten voorbehouden. <a href='https://www.destiny.nl' target='_blank'><b>www.destiny.nl</b></a><br>";
		}
		else
		{
			$message = "<h3><b>Destiny Cookie Plugin 1.0.10</b></h3>
			...
			Version 1.0.10, copyright &copy; 2021 - $year Destiny B.V., all rights reserved. <a href='https://www.destiny.nl' target='_blank'><b>www.destiny.nl</b></a><br>";
		}
